...
public class Tela_listar_bebida extends javax.swing.JFrame {//Tela de listagem das bebidas.
    ...
    /*
    Quando uma nova instância da tela Tela_listar_bebida é criada ela inicializa todos os componentes da interface.
    ...
    */
    ...
    private void initComponents() {
        ...
        setTitle("Tela_listar_bebida");
        setMinimumSize(new java.awt.Dimension(856, 667));
        setPreferredSize(new java.awt.Dimension(856, 671));
        getContentPane().setLayout(null);

        jLabel1.setFont(new java.awt.Font("Segoe UI", 0, 48)); // NOI18N
        jLabel1.setText("Bebidas");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(330, 20, 165, 64);
        ...
        jScrollPane1.setBounds(10, 90, 820, 402);
        ...
        jButton1.setBounds(190, 530, 110, 40);
        ...
        jButton2.setBounds(530, 530, 110, 40);

        jLabel2.setText("jLabel2");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(10, 610, 840, 16);

        jLabel3.setIcon(new javax.swing.ImageIcon("D:\\Sistema_Funcional_de_Bebidas\\Sistema_Funcional_de_Bebidas\\Sistema_Funcional_de_Bebidas\\src\\main\\java\\Imagem\\Fundo Listar Bebida 900-700.png")); // NOI18N
        getContentPane().add(jLabel3);
        jLabel3.setBounds(0, 0, 860, 670);
    ...
    /*
    O metodo de ListarBebida é utilizado para preencher a tabela jTable1 com os dados de todas as bebidas.
    Ele obtém a lista de bebidas do banco de dados.
    Limpa a tabela e  adiciona uma nova linha para cada bebida na lista.
    ...
    */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela_listar_bebida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tela_listar_bebida().setVisible(true);
            }
        });
    }
